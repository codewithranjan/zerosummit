...
<?php include ("header.php");?>
  ...
  <img src="assets/img/img1.jpg" alt="" data-aos="fade-in" style="width:100%; height:auto;">

  <div class="container d-flex justify-content-center align-items-center" style="min-height:100vh; text-align:center;">
    <div class="row">
      <div class="col-lg-8 mx-auto">
        <h4 data-aos="fade-up" data-aos-delay="200">An International Conference</h4>
        <h4 data-aos="fade-up" data-aos-delay="200">on</h4>
        <h4 data-aos="fade-up" data-aos-delay="200">Resilient Urbanism and Safe Mobility</h4>
        <h2 data-aos="fade-up" data-aos-delay="100">2ND VISION ZERO SUMMIT</h2>
        <p data-aos="fade-up" data-aos-delay="200">organised  by: MAULANA AZAD NATIONAL INSTITUTE OF TECHNOLOGY (MANIT), BHOPAL In association with NATIONAL INSTITUTE OF DISASTER MANAGEMENT (NIDM), NEW DELHI GOVERNMENT OF INDIA</p>
      </div>
      <div class="col-lg-5 mx-auto" data-aos="fade-up" data-aos-delay="300" style="border:2px solid white;background-color: #0C8E4F;margin-top:5px;">
        <h3>26th – 28th March, 2025</h3>
      </div>
    </div>
  </div>
